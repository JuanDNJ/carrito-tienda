...
export function Cart() {
    ...
    return (
        <>
            {isToggle && <section className={styles.cart}>
                ...
                <footer className={styles.checkout}>
                    <div className={styles.viewCart}>
                        <Link className={styles.linkViewCart} to="view-my-cart">View and edit cart</Link>
                    </div>
                    <Link className={styles.linkCheckOut} to="checkout-my-cart">Go to checkout</Link>
                </footer>
            </section>}
        </>
    )
